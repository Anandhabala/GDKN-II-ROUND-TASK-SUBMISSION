  ...
  return (
    <>
      <div class="container">
        {update ? (
          <>
            <div className="createACwholedesign">
              <div class="card">
                <div class="caheader">CREATE ACCOUNT</div>
                <div class="card-body">
                 <div id="acreateACcoinstylei">
                   <img id="createAcoinimage" src="reserve.jpg"></img>
                  </div>
                  <form onSubmit={handleSubmit}>
                    <div class="form-group">
                      <label class="labelnameCA">Name:</label>
                      <input
                        type="type"
                        class="form-control"
                    ...
                    <div class="mb-3">
                      <label class="labelemailCA">Email Address:</label>
                      <input
                        type="email"
                        class="form-control"
                        id="exampleInputEmail1"
                    ...
                    <div class="mb-3">
                      <label for="exampleInputPassword1" class="labelpasswordCA">
                        Password
                      </label>
                      <input
                        type="password"
